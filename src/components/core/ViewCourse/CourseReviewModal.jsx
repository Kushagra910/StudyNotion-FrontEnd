...
const CourseReviewModal = ({ setReviewModal }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] !mt-0 flex h-screen w-screen items-center flex-col overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
